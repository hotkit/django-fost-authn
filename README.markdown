...
In order to authenticate against the back end requests must be properly signed. `fost_authn.signature' includes two functions for doing this that can be used.
